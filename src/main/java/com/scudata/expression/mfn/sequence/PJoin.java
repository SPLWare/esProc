...
public class PJoin extends SequenceFunction {
	...
	public Object calculate(Context ctx) {
		...
		Sequence []sequences = new Sequence[tableCount]; // 关联游标数组
		...
		return srcSequence.pjoin(srcKeyExps, srcNewExps, srcNewNames, 
				sequences, options, keyExps, newExps, newNames, option, ctx);
	}
}
