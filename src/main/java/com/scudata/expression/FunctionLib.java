...
public final class FunctionLib {
	...
	public static void addFunction(String fnName, String className) {
		try {
			Class<? extends Function> funClass = (Class<? extends Function>) Class
					.forName(className);
	...
	public static void addMemberFunction(String fnName, String className) {
		try {
			Class<? extends MemberFunction> fnClass = (Class<? extends MemberFunction>) Class
					.forName(className);
	...
	private static void loadExt(InputStream is, ClassLoader loader)
		...
		for (Property property : properties) {
			...
			if (type.equals("0")) {
				...
				Class<? extends Function> cls = (Class<? extends Function>) loader
						.loadClass(clsName);
				m0.put(name, cls);
