...
public class DBTypes {
	...
	public static final int OPENGAUSS = 30;

	public static final int OCEANBASE_MYSQL = 31;
	...
	public static int[] listSupportedDBTypes() {
		return new int[] { ORACLE, SQLSVR, SYBASE, SQLANY, INFMIX, FOXPRO,
				...
				CLICKHOUSE, DORIS, OPENGAUSS, OCEANBASE_MYSQL,
				OCEANBASE_ORACLE, POLARDB_POSTGRESQL, ESSBASE };
	}
	...
	public static String[] listSupportedRDBNames() {
		return new String[] { "ORACLE", "SQLSVR", "SYBASE", "SQLANY", "INFMIX",
				...
				"DORIS", "OPENGAUSS", "OCEANBASE_MYSQL", "OCEANBASE_ORACLE",
				"POLARDB_POSTGRESQL" };
