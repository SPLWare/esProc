...
import com.raqsoft.ide.common.dialog.DialogMissingFormat;
...
public class DialogOptions extends JDialog {
	...
	private boolean save() throws Throwable {
		...
		config.setMainPath(com.raqsoft.ide.common.ConfigOptions.sMainPath);
		config.setTempPath(com.raqsoft.ide.common.ConfigOptions.sTempPath);
		...
		config.setCharSet(com.raqsoft.ide.common.ConfigOptions.sDefCharsetName);
		config.setLocalHost(com.raqsoft.ide.common.ConfigOptions.sLocalHost);
		config.setLocalPort(com.raqsoft.ide.common.ConfigOptions.iLocalPort == null ? null
				: com.raqsoft.ide.common.ConfigOptions.iLocalPort.toString());
		config.setFetchCount(com.raqsoft.ide.common.ConfigOptions.iFetchCount == null ? (ICursor.FETCHCOUNT + "")
				: com.raqsoft.ide.common.ConfigOptions.iFetchCount.toString());
		config.setBufSize(com.raqsoft.ide.common.ConfigOptions.sFileBuffer);
		config.setBlockSize(com.raqsoft.ide.common.ConfigOptions.sBlockSize);
	...
	public static String[] getPaths() {
		String sPaths = com.raqsoft.ide.common.ConfigOptions.sPaths;
