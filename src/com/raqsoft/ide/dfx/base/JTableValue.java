...
import com.raqsoft.ide.common.swing.GeneralRenderer;
import com.raqsoft.ide.common.swing.JTableEx;
import com.raqsoft.ide.common.swing.JTextFieldReadOnly;
...
public class JTableValue extends JTableEx {
	 ...
	 * 集算器资源管理器
	 */
	private static MessageManager mm = IdeDfxMessage.get();
	/**
	 * 序号列名
	 */
	...
	private int getPageRows() {
		int height = GVDfx.panelValue.spValue.getPreferredSize().height;
		...
		com.addMouseWheelListener(new MouseWheelListener() {
			public void mouseWheelMoved(MouseWheelEvent e) {
				if (e.getScrollType() == MouseWheelEvent.WHEEL_UNIT_SCROLL) {
					...
					JScrollBar sbValue = GVDfx.panelValue.sbValue;
	...
	public void setLocked(boolean locked) {
		...
		GVDfx.panelValue.valueBar.setLocked(locked);
	}
	...
	public void mousePressed(MouseEvent e) {
		...
		row += GVDfx.panelValue.sbValue.getValue() - 1;
	...
	private void resetSelection() {
		...
		if (!selectedRows.isEmpty()) {
			...
			for (int i = 0; i < selectedRows.size(); i++) {
				...
				r = r - GVDfx.panelValue.sbValue.getValue() + 1;
	...
	private synchronized void resetValue(boolean forceSetValue, Object aValue,
		...
		try {
			...
			try {
				GVDfx.panelValue.preventChange = true;
				GVDfx.panelValue.sbValue.setMinimum(1);
				GVDfx.panelValue.sbValue.setMaximum(rowCount);
				GVDfx.panelValue.sbValue.setValue(dispStartIndex);
				GVDfx.panelValue.spValue.getHorizontalScrollBar().setValue(1);
				resetData(dispStartIndex);
			} finally {
				GVDfx.panelValue.preventChange = false;
			}
		}
	}
