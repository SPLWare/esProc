...
import com.raqsoft.expression.mfn.sequence.Find;
...
public class Cursor extends IDWCursor {
	...
	private static ColumnMetaData getColumn(ColumnTableMetaData table, Node node) {
		...
		} else if (node instanceof com.raqsoft.expression.fn.math.And) {
		...
		if (node instanceof And) {
			...
			if (column != null) {
				try {
					...
					if (left instanceof com.raqsoft.expression.fn.math.And) {
