...
public class ByteArrayInputRecord {
  ...
  public IRecord readRecord(IRecord r) throws IOException,
  ...
  public Object readObject(boolean test) throws IOException,
	  ClassNotFoundException {
	  int b = readByte();
	  switch (b) {
	  case -1:
  ...
  public IRecord readRecord2(IRecord r) throws IOException,
