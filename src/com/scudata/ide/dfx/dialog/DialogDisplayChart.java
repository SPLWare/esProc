...
import com.scudata.ide.dfx.chart.auto.DialogGraphEdit;
import com.scudata.ide.dfx.chart.auto.JComboBoxGraph;
import com.scudata.ide.dfx.resources.ChartMessage;
...
public class DialogDisplayChart extends JDialog {
	...
	MessageManager dfxMM = IdeDfxMessage.get();
	...
	private void resetLangText() {
		String svgTip = "";
		if (!copy.isEnabled()) {
			svgTip = dfxMM.getMessage("dialogdisplaychart.svgtip");
		}
		setTitle(dfxMM.getMessage("dialogdisplaychart.title", svgTip)); // 图形预览
		close.setText(dfxMM.getMessage("button.close")); // 关闭
		saveAs.setText(dfxMM.getMessage("button.saveas")); // 另存为
		copy.setText(dfxMM.getMessage("button.copy")); // 复制
		labelGraphType.setText(dfxMM.getMessage("dialogdisplaychart.graphType"));
		labelCategory.setText(dfxMM.getMessage("dialogdisplaychart.category"));
		labelSeries.setText(dfxMM.getMessage("dialogdisplaychart.series"));
		labelValue.setText(dfxMM.getMessage("dialogdisplaychart.value"));
		labelAccumulate.setText(dfxMM.getMessage("dialogdisplaychart.accumulate"));
		settings.setText(dfxMM.getMessage("dialogdisplaychart.settings"));

		labelFrameCount.setText(dfxMM.getMessage("dialogdisplaychart.framecount"));
		labelFrameDelay.setText(dfxMM.getMessage("dialogdisplaychart.frameDelay"));
		cbLoop.setText(dfxMM.getMessage("dialogdisplaychart.loop"));
		play.setText(dfxMM.getMessage("dialogdisplaychart.play"));
	}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (engine == null) {
					...
					try {
						...
						age.finish();
						GM.showException(dfxMM.getMessage("dialogdisplaychart.saveinfo",saveFile));
					} catch (Exception x) {
						GM.showException(x);
					}
					return;
	...
	private void initAnimate() {
		...
		final String PLAY = dfxMM.getMessage("dialogdisplaychart.play");
		final String STOP = dfxMM.getMessage("dialogdisplaychart.stop");
